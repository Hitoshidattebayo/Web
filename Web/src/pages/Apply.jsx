...
const Apply = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        major: '',
        message: '',
        reservationDate: '' // Added date field
    });
        ...
        <div style={{
            ...
            <div className="container" style={{
                ...
                <p style={{ textAlign: 'center', marginBottom: '3rem', color: 'var(--color-text-muted)' }}>
                    {step === 1
                        ? "Та өөрт тохиромжтой өдрөө календараас сонгоно уу."
                        : "Таны сонгосон өдөр: " + reservationDate?.toLocaleDateString() + ". Доорх формыг бөглөн баталгаажуулна уу."
                    }
                </p>
                    ...
                    <div style={{ position: 'relative', animation: 'fadeIn 0.5s ease' }}>
                        ...
                        <form onSubmit={handleSubmit} style={{ backgroundColor: 'white', padding: '2rem', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-md)' }}>
                            <div style={{ marginBottom: '1.5rem' }}>
                                <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 'bold' }}>Сонгосон өдөр</label>
                                <input
                                    type="text"
